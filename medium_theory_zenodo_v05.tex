...
\label{sec:org9bb12ff}
\subsection{The Core Problem}
\label{sec:orgce42257}
...
\subsection{Axioms}
\label{sec:org29f748d}

\subsubsection{Axiom I --- The Eternal Medium}
\label{sec:orgfc3e774}
...
\label{sec:org060edc0}

\subsubsection{Primitive I --- The Field}
\label{sec:org4c78511}
...
Color charge & May dissolve as labeling artifact; never directly observed (confinement) & Dissolution candidate; derivation may not be required & Open\\[0pt]
