...
Open problem flagged for theorists: the proton is a fermion obeying Fermi-Dirac statistics and the Pauli exclusion principle. The bosonic Lagrangian above cannot produce this. Either: (a) the negotiation field must be Grassmann-valued (anticommuting) to give fermionic statistics, or (b) a composite antisymmetrization argument must show that three bosonic quanta in the triangle mode acquire fermionic exchange statistics collectively. Neither has been established. This is a primary open problem for the framework.

\section{Document Series and Cross-References}
\label{sec:orgc23e581}
