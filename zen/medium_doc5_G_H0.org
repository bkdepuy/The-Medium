...
All three paths give mutually consistent results within the identified correction factors. This triangular consistency is strong evidence that the framework is not fitting three separate numbers but is describing a single underlying structure with three observable manifestations.
...
\end{enumerate}
All four predictions are correlated consequences of $H_0$ changing over cosmic time. Measuring these correlations over cosmological time would provide a powerful test of the framework.
\end{predbox}
#+END_EXPORT
...
This is Document 5 of 5 in The Medium Framework series.
