...
\subsection{Axioms}
\label{sec:org0108050}

\subsubsection{Axiom I --- The Eternal Medium}
\label{sec:org6c18628}
...
\emph{Status: Current.}
\subsubsection{Primitive III --- Transition}
\label{sec:orgdc455b1}
...
\emph{Status: Current.}
\subsubsection{Primitive IV --- The Propagation Limit}
\label{sec:orgc893eac}
...
\subsubsection{Primitive V --- Structure Formation}
\label{sec:org43489ea}
...
\emph{Status: Provisional.}
\subsubsection{Primitive VI --- Co-Manifestation}
\label{sec:org46e5f18}
...
\item \(\iota\) manifests --- \(\phi\) flips from 0 to 1 --- minimum local distinction.
