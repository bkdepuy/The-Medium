...
What it asks instead is the question: /from where did it begin?/ The equations of physics are precise maps. The challenge is to identify the territory they map --- not the territory of observable phenomena, which physics has surveyed magnificently, but the foundation that gives rise to a universe in which observation is possible at all.
...
#+BEGIN_QUOTE
/*Out of infinite nothing all of creation becomes.*/
