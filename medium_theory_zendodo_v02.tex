...
\section{I. The Foundational Claim}
\label{sec:org53900e6}
...
not apply to it.
\section{II. The Stochastic Character of the Medium}
\label{sec:orgd48de1d}
...
\subsection{II.I The Ground State as Fully Random Autonomous Stochastic System}
\label{sec:org3811a64}
...
\subsection{II.II What Fully Random Stochastic Nothingness Implies}
\label{sec:org8211268}
...
\subsection{II.III The Relationship Between Stochastic Character and \(\iota\)}
\label{sec:orge836b29}
...
\end{itemize}
\subsection{II.IV Connection to Existing Physics}
\label{sec:orgf5ac99b}
...
any possibility.
\section{III. Axioms and Primitives — Version 0.3}
\label{sec:org6c3b753}
...
\subsection{III.I Axiom I — The Eternal Medium}
\label{sec:org750a931}
...
\subsection{III.II Axiom II — Intrinsic Distinction}
\label{sec:orgcfc241d}
...
\subsection{III.III Axiom III — Locality Emergence}
\label{sec:org0172daa}
...
\emph{Status: Axiomatic.}
\subsection{III.IV Primitive I — The Medium}
\label{sec:org3d4137f}
...
\subsection{III.V Primitive II — The Population Function}
\label{sec:orgc813336}
...
\emph{Status: Current.}
\subsection{III.VI Primitive III — The Manifestation Probability}
\label{sec:org4f1bde0}
...
\emph{Status: Current.}
\subsection{III.VII Primitive IV — Transition}
\label{sec:orga8532fa}
...
\emph{Status: Current.}
\subsection{III.VIII Primitive V — The Propagation Limit}
\label{sec:orgabe75c9}
...
\subsection{III.IX Primitive VI — The Structure Formation Condition}
\label{sec:org7b0da03}
...
\emph{Status: Provisional.}
\section{IV. The Entropic Arc}
\label{sec:org9d8007d}
...
standard cosmology.
\subsection{IV.I The Ground State as Maximum Entropy}
\label{sec:org92ddadd}
...
\subsection{IV.II Intrinsic Distinction as a Low Entropy Event}
\label{sec:org6232c49}
...
\subsection{IV.III Resolution of the Low Entropy Initial Condition Problem}
\label{sec:orgb9b98c3}
...
\subsection{IV.IV The Full Entropic Arc}
\label{sec:org7f15f0a}
...
\subsection{IV.V The Shannon Connection}
\label{sec:org7f02dcb}
...
\begin{itemize}
\item The minimum local entropy event in Boltzmann's thermodynamic sense
\item The maximum possible information emergence event in Shannon's information
theoretic sense
\item The first stochastic actualization in the autonomous random system of the Medium
\end{itemize}
...
John Wheeler's formulation — \emph{it from bit} — proposes that information is more
...
\section{V. The Problem With Where We Started}
\label{sec:org3e48cb6}
...
\section{VI. What the Framework Proposes}
\label{sec:org41d3eed}

\subsection{VI.I The Medium}
\label{sec:orgb6e843c}
...
\subsection{VI.II Nothing Moves}
\label{sec:org76a9ef0}
...
substrate.
\subsection{VI.III The Ground State}
\label{sec:org5c4574b}
...
\subsection{VI.IV On Time}
\label{sec:orgdadec3d}
...
\subsection{VI.V On Existing Physics}
\label{sec:org31c6f02}
...
applicable emerge.
\section{VII. The Convergence With Human Thought}
\label{sec:org25c9778}
...
Within physics, Wheeler's \emph{it from bit} proposes information as more fundamental
...
\section{VIII. Unresolved Questions}
\label{sec:org251b3ae}
...
\section{IX. Summary of Axioms and Primitives}
\label{sec:org42d89ca}
...
\end{tabular}
\end{center}
\section{X. A Personal Note}
\label{sec:org05fe552}
