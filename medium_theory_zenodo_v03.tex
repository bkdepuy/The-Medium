...
\fancypagestyle{body}{%
\fancyhf{}%
\fancyhead[C]{\small Version 0.3 $\cdot$ DOI: 10.5281/zenodo.18927154 $\cdot$ CC BY 4.0}%
\fancyfoot[C]{\thepage}%
...
\subsection{Axioms}
\label{sec:org1e5749d}

\subsubsection{Axiom I --- The Eternal Medium}
\label{sec:org322f8d5}
...
\label{sec:org7623806}

\subsubsection{Primitive I --- Manifestation}
\label{sec:org852e95e}
